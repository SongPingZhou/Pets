...
<div class="content container">
	<div class="breadcrumbs">
		<a href="../index.jsp">首页</a><span>></span><a href="index.jsp">帮助中心</a><span>></span>积分兑换
	</div><!--breadcrumbs end-->
	...
	<div class="content_main clearfix">
		<div class="f_l c_l">
			...
			<dl>
				...
				<dd><a class="current" href="help/exchange-integral.jsp"><span>积分兑换</span></a></dd>
			</dl>
			<dl>
				<dt>如何付款/退款</dt>
		...
		<div class="f_r c_r">
			...
			<div class="help_r_t_m">
				<dl>					
					<dt>部分积分兑换</dt>
					<dd>“现金”&nbsp;+&nbsp;“积分”&nbsp;&nbsp;购买方式，下次购买可累积积分。</dd>
					<dt>全额积分兑换</dt>
					<dd>“全额积分”&nbsp;&nbsp;购买方式，下次购买不能累积积分。</dd>
				</dl>						
			</div>
		</div><!--c_r end-->
	</div>
