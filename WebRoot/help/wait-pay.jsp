...
<div class="content container">
	<div class="breadcrumbs">
		<a href="../index.jsp">首页</a><span>></span><a href="index.jsp">帮助中心</a><span>></span>支付等待
	</div><!--breadcrumbs end-->
	...
	<div class="content_main clearfix">
		<div class="f_l c_l">
			...
			<dl>
				...
				<dd><a class="current" href="help/wait-pay.jsp"><span>支付等待</span></a></dd>
		...
		<div class="f_r c_r">
			...
			<div class="help_r_t_m">
				<dl>					
					<dt>在线支付方式</dt>
					<dd>如果在24小时之内未收到您的款项，系统将自动取消订单。</dd>
					<dt><b class="red">温馨提示：</b></dt>
					<dd>货到付款没有等待时间，请直接拨打客服电话：15537889957</dd>
				</dl>						
			</div>
		</div><!--c_r end-->
	</div>
