...
<div class="content container">
	<div class="breadcrumbs">
		<a href="../index.jsp">首页</a><span>></span><a href="index.jsp">帮助中心</a><span>></span>发票制度
	</div><!--breadcrumbs end-->
	...
	<div class="content_main clearfix">
		<div class="f_l c_l">
			...
			<dl>
				...
				<dd><a class="current" href="help/invoice-system.jsp"><span>发票制度</span></a></dd>
			</dl>
			<dl>
				<dt>配送和收费</dt>
		...
		<div class="f_r c_r">
			...
			<div class="help_r_t_m">
				<dl>					
					...
					<dt>2.宠物之家是否提供增值税发票?</dt>
					<dd>目前，还未提供增值税发票。</dd>
					
					<dt>3.开发票的注意事项</dt>
					<dd>（1）发票金额不能高于订单金额。</dd>
					<dd>（2）非现金虚拟账户支付的金额和电子优惠券的金额不开发票。（非现金虚拟账户如：宠物之家的一些促销活动中赠送的商品、电子优惠券、积分购买。）
