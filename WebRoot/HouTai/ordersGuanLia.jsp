...
<script type="text/javascript" src="HouTai/js/jquery-1.8.2.min.js"></script>
	 ...
	 var OrderId= document.getElementById("OrderId").value;
		layui.use("table", function() {
			...
			table.render({
				...
				method : "post",
				height : 900,
				url : "../Pets/SelectServlet?method=SelectOrdersGuanLia&OrderId="+OrderId,
				toolbar : "#inputid",
				width : 1250,
				page : true,
				cols : [ [ {
			   ...
			   if (layEvent == 'edi') {
				...
				layer
						.open({
							title : "修改",
							type : 2,
							content : "../Pets/UpdateByid?method=UpdateOrdersAllByid&id="+ id,
							offset:["250px","400px"],
							area : [ "300px",
									"200px" ],
						});
  ...
  <script type="text/html" id="inputidx">
  	    <a class="layui-btn layui-btn-radius layui-btn-warm layui-btn-sm" lay-event="edi">编辑</a>
	</script>
  <body>
  <center>
